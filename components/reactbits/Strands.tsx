...
// Strands de React Bits (https://www.reactbits.dev), variante JS + CSS.
// Adaptado a TypeScript para Lead Pilot. Lógica original intacta; se añadió
// tipado y una guarda de prefers-reduced-motion (render estático si aplica).
...
export default function Strands({
  ...
  useEffect(() => {
    ...
    let animateId = 0;
    // Con prefers-reduced-motion: un solo cuadro estático, sin bucle.
    if (reduce) {
      renderFrame(1500);
    } else {
