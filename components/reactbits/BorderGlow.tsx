...
// Componente BorderGlow de React Bits (https://www.reactbits.dev)
// Variante JavaScript + CSS, adaptada a TypeScript para este proyecto.
// Mantiene la lógica original; solo se agregó tipado y guardas de SSR.
...
const BorderGlow = ({
  ...
  const handlePointerMove = useCallback(
    (e: React.PointerEvent<HTMLDivElement>) => {
      ...
      if (!card) return;
      // Solo con mouse fino: en táctil no aporta y evita repintados al hacer scroll.
